<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="technology" :permalink="data.body.permalink" />
  </div>
</template>

<script>
import commonEdit from '~/components/templates/commonEdit'
import postMeta from '~/components/templates/meta/Technology'
import postRelative from '~/components/templates/relative/Technology'
import snackeBar from '~/components/templates/snackbar'
import postPreview from '~/components/lib/MM_Post_Preview'
    export default {
        name: "singleTechnologyPage",
        layout: 'admin',
