<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="technologies" :permalink="data.body.permalink" />
  </div>
</template>
...
import postPreview from '~/components/lib/MM_Post_Preview'
    export default {
        name: "singleTechnologyCategoryPage",
        layout: 'admin',
        ...
        data(){
          return {
              POST_TYPE: 'technology_category',
              PATH_CATEGORY: 'technology/category',
              data:{
                body: undefined
              },
              snackbar:{
