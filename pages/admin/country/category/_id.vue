<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="countries" :permalink="data.body.permalink" />
  </div>
</template>
...
import postPreview from '~/components/lib/MM_Post_Preview'
    export default {
        name: "singleCountryCategoryPage",
        layout: 'admin',
        ...
        data(){
          return {
              POST_TYPE: 'country_category',
              PATH_CATEGORY: 'country/category',
              data:{
                body: undefined
              },
              snackbar:{
