<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="country" :permalink="data.body.permalink" />
  </div>
</template>

<script>
import commonEdit from '~/components/templates/commonEdit'
import postMeta from '~/components/templates/meta/Country'
import postRelative from '~/components/templates/relative/Country'
