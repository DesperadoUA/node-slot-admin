    ...
    <v-container class="container--fluid">
      <v-row>
        <v-col class="offset-1 col-10 mt-10">
          <h1 class="page_title font-podkova-bold">Type Payment category</h1>
        </v-col>
      </v-row>
      <v-row>
...
<script>
  ...
  export default {
        ...
        data(){
          return {
              POST_TYPE: 'type_payment_category',
              POST_DB: 'type_payment_category',
              data: {
                  ru: {
                      post_slug: 'type-payment/category',
                      lang: 'ru',
                      posts: [],
                      total: 0
                  },
