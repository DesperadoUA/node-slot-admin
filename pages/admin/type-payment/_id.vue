<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="type-payment" :permalink="data.body.permalink" />
  </div>
</template>

<script>
import commonEdit from '~/components/templates/commonEdit'
import postMeta from '~/components/templates/meta/TypePayment'
import postRelative from '~/components/templates/relative/TypePayment'
import snackeBar from '~/components/templates/snackbar'
import postPreview from '~/components/lib/MM_Post_Preview'
    export default {
        name: "singleTypePaymentPage",
        layout: 'admin',
